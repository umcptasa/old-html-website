var pos = 0;
var lng_A = 0, lng_B = 0, lng_C = 0, lng_D = 0, lng_E = 0;
...
function startQuiz() {
    ...
    $("#test").replaceWith("<div id='test'><h3><i>It's more meaningful to me when</i></h3> <form id='questions'></form> <a class='myButton' id='next' onclick='nextQuestion()'>Next Question</a><div id='error'></div></div>");
...
function renderQuestion() {
    var choice1 = questions[pos][0];
    var choice2 = questions[pos][1];
    var value1 = questions[pos][2];
    var value2 = questions[pos][3];
    var length = questions.length;

    $('#test-status').text("Question " + (pos + 1) + " of " + length);
    $('#error').text("");
